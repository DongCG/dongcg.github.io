...
module.exports = __webpack_require__.p + "public/images/614e9f81.favicon.png";
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { style: btStyle, onClick: this.props.onPreClicked },
                    '\u4E0A\u4E00\u9801'
                ),
                _react2.default.createElement(
                    'div',
                    { style: btStyle, onClick: this.props.onNextClicked },
                    '\u4E0B\u4E00\u9801'
                )
            );
        }
...
var _AppItem = __webpack_require__(80);
...
var AppList = function (_PureComponent) {
    _inherits(AppList, _PureComponent);

    function AppList() {
        _classCallCheck(this, AppList);

        var _this = _possibleConstructorReturn(this, (AppList.__proto__ || Object.getPrototypeOf(AppList)).call(this));
    ...
    _createClass(AppList, [{
        ...
        value: function componentWillMount() {
            ...
            items = APPS.map(function (item, index) {
                return _react2.default.createElement(_AppItem2.default, {
                    key: index,
                    app: APPS[index],
                    onClick: function onClick() {
                        _this2.props.onItemClick(index);
                    } });
            });
        }
    }, {
        key: 'onPreClicked',
        value: function onPreClicked() {
        ...
        value: function onNextClicked() {
            ...
            var maxPage = Math.ceil(items.length / ITEMSPERPAGE) - 1;
            console.log(maxPage);
        ...
        value: function render() {
            ...
            var ll = items.filter(function (elem, index) {
                return index >= _this3.state.page * ITEMSPERPAGE && index < (_this3.state.page + 1) * ITEMSPERPAGE;
            });
            return _react2.default.createElement(
                'div',
                { style: container },
                ll,
                _react2.default.createElement(_Pager2.default, { onPreClicked: this.onPreClicked.bind(this), onNextClicked: this.onNextClicked.bind(this) })
            );
        }
    }]);
...
var AppContent = function (_PureComponent) {
    _inherits(AppContent, _PureComponent);
    ...
    _createClass(AppContent, [{
        key: 'render',
        value: function render() {
            var app = APPS[this.props.appindex];
            return _react2.default.createElement(
                'div',
                { style: container, onClick: this.props.onClick },
                _react2.default.createElement(
                    'table',
                    { style: tabStyle, border: '1' },
                    _react2.default.createElement(
                        'tr',
                        { style: trStyle },
                        _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { style: btStyle, href: './public/products/' + app.name + '.jar' },
                    '\u4E0B\u8F09'
                )
            );
        }
...
var _Banner = __webpack_require__(72);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(11), __webpack_require__(63)(module)))
    ...
    _createClass(Banner, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { style: container },
                _react2.default.createElement('img', { style: imgStyle, src: __webpack_require__(27) }),
                _react2.default.createElement(
                    'span',
                    { style: txtStyle },
                    '\u4F11 \u9592 \u5A1B \u6A02 \u8EDF \u9AD4'
...
var _News = __webpack_require__(75);

var _News2 = _interopRequireDefault(_News);

var _Apps = __webpack_require__(79);
...
var Main = function (_PureComponent) {
    ...
    _createClass(Main, [{
        key: 'onMenuItemClick',
        value: function onMenuItemClick(tab) {
            this.setState({
                tab: tab
            });
        }
        ...
        value: function render() {
            switch (this.state.tab) {
                case 0:
                    this.comp = _react2.default.createElement(_News2.default, null);
                    break;
                case 1:
                    this.comp = _react2.default.createElement(_Apps2.default, null);
                    break;
                case 2:
                    this.comp = _react2.default.createElement(_About2.default, null);
                    break;
            }
            ...
            return _react2.default.createElement(
                'div',
                { style: container },
                _react2.default.createElement(_Menu2.default, { selectedTab: this.state.tab, onMenuItemClick: this.onMenuItemClick.bind(this) }),
                this.comp
            );
        }
    }]);
    ...
    _createClass(Menu, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'menuItem', style: this.props.selectedTab == 0 ? activeItem : item, onClick: function onClick() {
                            _this2.props.onMenuItemClick(0);
                        } },
                    '\u65B0\u805E'
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'menuItem', style: this.props.selectedTab == 1 ? activeItem : item, onClick: function onClick() {
                            _this2.props.onMenuItemClick(1);
                        } },
                    '\u7522\u54C1'
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'menuItem', style: this.props.selectedTab == 2 ? activeItem : item, onClick: function onClick() {
                            _this2.props.onMenuItemClick(2);
                        } },
                    '\u95DC\u65BC'
                )
            );
...
var News = function (_PureComponent) {
    ...
    _createClass(News, [{
        key: 'onItemClick',
        value: function onItemClick(newsindex) {
            this.setState({
                newsindex: newsindex
            });
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { style: container },
                _react2.default.createElement(_List2.default, { onItemClick: this.onItemClick.bind(this) }),
                _react2.default.createElement(_Content2.default, { newsindex: this.state.newsindex })
            );
        }
    }]);
...
var _NewsItem = __webpack_require__(77);
...
var List = function (_PureComponent) {
    ...
    _createClass(List, [{
        ...
        value: function componentWillMount() {
            ...
            items = NEWS.map(function (item, index) {
...
var NewsItem = function (_PureComponent) {
    _inherits(NewsItem, _PureComponent);
    ...
    _createClass(NewsItem, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'listitem', style: container, onClick: this.props.onClick },
                _react2.default.createElement(
                    'span',
                    { style: txtStyle },
                    news.title
...
var Content = function (_PureComponent) {
    ...
    _createClass(Content, [{
        ...
        value: function render() {
            ...
            var news = NEWS[this.props.newsindex];
...
var _AppList = __webpack_require__(29);

var _AppList2 = _interopRequireDefault(_AppList);

var _AppContent = __webpack_require__(30);
...
var Apps = function (_PureComponent) {
    _inherits(Apps, _PureComponent);
    ...
    _createClass(Apps, [{
        key: 'onItemClick',
        value: function onItemClick(appindex) {
            this.setState({
                appindex: appindex
            });
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { style: container },
                _react2.default.createElement(_AppList2.default, { onItemClick: this.onItemClick.bind(this) }),
                _react2.default.createElement(_AppContent2.default, { appindex: this.state.appindex })
            );
        }
    }]);
...
var AppItem = function (_PureComponent) {
    _inherits(AppItem, _PureComponent);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('img', { src: __webpack_require__(27), style: imgStyle })
                ),
                _react2.default.createElement(
                    'div',
                    { style: txtStyle },
                    _react2.default.createElement(
                        'p',
                        null,
                        '\u4F11\u9591\u5A1B\u6A02\u8EDF\u9AD4\u79D1\u6280\u6709\u9650\u516C\u53F8\u6210\u7ACB\u4E8E2016\u5E7412\u6708\uFF0C\u516C\u53F8\u7E3D\u90E8\u4F4D\u65BC\u5927\u6B63\u570B\u9435\u57CE\u5E02\u8EDF\u9AD4\u5927\u9053\u8EDF\u9AD4\u5546\u52D9\u5927\u5EC823-27\u5C64\uFF0C\u516C\u53F8\u4EE5\u904A\u6232\u8EDF\u9AD4\u958B\u767C\u70BA\u4E3B\u71DF\u696D\u52D9\uFF0C\u516C\u53F8\u5B97\u65E8\u70BA\u7ACB\u8DB3Java\u3002'
                    )
                )
            );
        }
...
global.ITEMSPERPAGE = 18; //列表每頁條目數量

global.NEWS = [{
    title: '3D初步實現',
    date: '2017/02/18',
    content: '參照《計算機圖形學原理》一書，採用變換矩陣，同時引入查資料獲得的鼠標拖拽方向判別方法，初步實現多角度正方體的三維觀察。'
}, {
    title: '返校',
    date: '2017/02/18',
    content: '今日起正式接手休娛軟體官網業務！'
}, {
    title: '官方站點正式啟動',
    date: '2017/02/14',
    content: '今天官網正式入駐外網，歡迎全球網友訪問。'
}];
...
global.APPS = [{
    ...
    date: '2018/02/18',
    size: '8.00KB',
    desc: '首次實現3D顯示，操作中用鼠標拖動可以變換視角。'
}, {
    name: 'SeaWar1.0',
    date: '2018/02/17',
    size: '26.7KB',
    desc: '本遊戲加入多種遊戲元素，畫面流暢，音效真實，并加入計分排名系統，增加競技感。'
}, {
    name: 'Giraffe Driver',
    date: '2017/05/21',
    size: '1.57MB',
    desc: '新版特性：1.允許玩家重新開始遊戲；2.有暫停功能（空白鍵暫停，G鍵繼續）；3.改用長頸鹿開車，更加真實；4.增加了更多的音頻和圖像資源。'
}, {
    name: 'cubicEquation',
    date: '2017/03/09',
    size: '12KB',
    desc: '該軟體首次運用了自定義的介面Func類用於表示函數，在工具箱類Toolbox中定義了二分逼近求解法，單向尋根法等工具，便於程式擴展。'
}, {
    name: 'Gambling1.0',
    date: '2017/02/10',
    size: '108KB',
    desc: '此遊戲首次引入隨機數的概念，讓玩家瞬間產生賭應，最後提醒各位：賭博有風險，貸錢需謹慎！'
}, {
    name: 'maze1.0',
    date: '2017/01/01',
    size: '4KB',
    desc: '次迷宮利用數陣原理進行貼圖，方法新穎。'
}];
